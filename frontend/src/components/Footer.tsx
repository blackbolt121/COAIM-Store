...
import logo from "../assets/siscadindustrial-recortado-blanco.svg"
import {Link} from "react-router-dom";
...
const WhatsAppIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 shrink-0" viewBox="0 0 24 24" fill="currentColor">
...
const FooterLink = ({ href, children }: FooterLinkProps) => {
    return <li>
        <Link to={href} onClick={()=>{
            //console.log(href);
        }} className="text-white hover:text-primary/80 hover:underline transition-colors duration-300">
            {children}
        </Link>
    </li>
};
...
const SocialIcon = ({ href, children, ariaLabel }: SocialLinkProps) => (
    <a
        ...
        className="text-white hover:text-primary/80 transform hover:scale-110 transition-transform duration-300"
        target="_blank"
...
const Footer = () => {
    ...
    return (
        <footer className={`${colors.background} ${colors.text} font-sans`}>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="location-item">
                                ...
                                <div className="mt-2 space-y-2 text-sm">
                                    ...
                                    <a href="mailto:suferred@gmail.com" className="flex items-center text-white hover:text-primary/80 transition-colors duration-300"><EnvelopeIcon /><span>suferred@gmail.com</span></a>
                                    <a href="https://api.whatsapp.com/send/?phone=%2B524422711285&text&type=phone_number&app_absent=0" className="flex items-center text-white hover:text-primary/80 transition-colors duration-300"><WhatsAppIcon /><span>WhatsApp</span></a>
                                </div>
                            </div>
                            ...
                            <div className="location-item">
                                ...
                                <div className="mt-2 space-y-2 text-sm">
                                    ...
                                    <a href="mailto:ventascoaimsa@gmail.com" className="flex items-center text-white hover:text-primary/80 transition-colors duration-300"><EnvelopeIcon /><span>ventascoaimsa@gmail.com</span></a>
            ...
            <div className="bg-primary/90 mt-8 py-4 px-4 sm:px-6 lg:px-8">
