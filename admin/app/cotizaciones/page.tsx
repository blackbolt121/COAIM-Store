            ...
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3 text-sm text-zinc-600">
                <div className="flex items-center justify-between">
                  <span>Subtotal</span>
                  <span className="font-medium text-zinc-950">{money(subtotal)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>IVA (16%)</span>
                  <span className="font-medium text-zinc-950">{money(iva)}</span>
                </div>
                <div className="flex items-center justify-between border-t border-zinc-200 pt-3 text-base">
                  ...
                  <span className="font-semibold text-emerald-700">{money(total)}</span>
                </div>
              </div>
