...
export type AdminUser = {
  ...
  roles?: Array<string | EntityRef> | null;
  groups?: Array<string | EntityRef> | null;
};
...
export type UserProfile = {
  ...
  email?: string;
  name?: string;
  roles?: Array<string | EntityRef>;
  groups?: Array<string | EntityRef>;
};
...
export async function getCurrentUser() {
  return apiFetch<UserProfile>("/rest/api/1/myself");
}
